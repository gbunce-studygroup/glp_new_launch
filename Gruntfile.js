module.exports = function(grunt) {
    ...
    grunt.initConfig({
        ...
        copy: {
            main: {
                files: [
                {
                    ...
                    dest: '///Volumes/Designer/css/globallandingpagesv2/_________ADD_BRAND_FOLDER_________/', // CHANGE TO MATCH THE CSS LOCATION ON STAGING
                    filter: 'isFile'
                }],
            },
        },
        ...
        replace: {
            glpbrand: {
                src: ['///Volumes/Designer/css/globallandingpagesv2/_________ADD_BRAND_FOLDER_________/glp_brand.css'], // CHANGE TO MATCH THE CSS LOCATION ON STAGING
                overwrite: true, // overwrite matched source files 
                replacements: [{
                    from: '../fonts/custom_font/',
                    to: "/fonts/globallandingpagesv2/brand/_________ADD_BRAND_FOLDER_________/" // CHANGE TO MATCH THE FONTS LOCATION ON STAGING
                }, {
                    from: '../img/',
                    to: "/images/globallandingpagesv2/images/_________ADD_BRAND_FOLDER_________/" // CHANGE TO MATCH THE IMAGE LOCATION ON STAGING
                }]
            }
        }
	});
